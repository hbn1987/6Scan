...
p.add_argument('analysis', help='Sim_experiment_downsampling3k_9k of a2-mining.py')
p.add_argument('--letters', action='store_true', help='decode using letters')
p.add_argument('--colons', action='store_true', help='use colons in Sim_experiment_downsampling3k_9k')
p.add_argument('--debug', action='store_true', help='use debug Sim_experiment_downsampling3k_9k format')
args = p.parse_args()
