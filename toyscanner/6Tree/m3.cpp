...
void s3_treeGenerate()
{
    ...
    cout << "Step 3.1: Generate Tree" << endl;
    // 1. 初始化树结构起始结点
    Xree.level = 1;
    Xree.number = 1;
    Xree.inf = 1;
...
void s3_entrance()
{
    ...
    s3_canGenerate(string(___FL_TREE), string(___FL_CANIPv6));
    s3_releaseTree();
