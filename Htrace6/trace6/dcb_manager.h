...
class DcbManager {
 public:
  ...
  // release the resource allocated for coarse address look up.
  void releaseCoarseMapping();

  void addDcbsFromReply(const IpAddress& destination, const uint8_t initialTtl, const uint32_t prefixLen);
