...
class ProbeUnitIpv6 {
 public:
  ...
  uint8_t ttl;
  uint32_t prefixLen;
  ProbeUnitIpv6() : ip(0), ttl(0), prefixLen(0){}
  ProbeUnitIpv6(const Ipv6Address& _ip, const uint8_t _ttl, const uint32_t _prefixLen)
      : ip(_ip), ttl(_ttl), prefixLen(_prefixLen){}
};
...
class NetworkManager {
 ...
 private:
  ...
  void probeRemoteHost(const IpAddress& destinationIp, const uint8_t ttl, const uint32_t prefixLen);
