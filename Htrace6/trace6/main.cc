...
#include "trace6/single_host.h"
#include "trace6/output_parser.h"
...
ABSL_FLAG(bool, remove_reserved_addresses, false,
...
int main(int argc, char* argv[]) {
  absl::SetProgramUsageMessage("trace6");
