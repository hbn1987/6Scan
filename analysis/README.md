...
```shell
AliasMatch.py # Match the addresses and the alias prefixes.
...
CountryResources.py # Download the country resource list in a run.
EUI64_analysis.py # EUI64 addresses analysis.
